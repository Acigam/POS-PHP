...
<tr>
    <td colspan="2" style="width:800px"><center><h2 style="margin-bottom:0px">Laporan Penjualan <?php echo $bulan ?></h2></center><br/></td>
</tr>
</table>

<table align='center' width='900px;' border='1'>
<thead>
    <th colspan="11" style="text-align:left;">Bulan : <?php echo $bulan;?></th>
    <tr>
...
<tbody>
    ...
    $sql = "SELECT detail_penjualan.id_transaksi, tgl_transaksi, karyawan.nama, total, barang.id_barang, 
            ...
            WHERE DATE_FORMAT(tgl_transaksi,'%M %Y') = '$bulan' ORDER BY detail_penjualan.id_transaksi";
    ...
    while ($data = mysqli_fetch_array($query, MYSQLI_ASSOC)){
        ...
        <tr>
            <?php
                ...
                <?php 
                $count++;
                $totalSeluruh = $totalSeluruh + $total;
                }
                else { 
                ?>
...
<tfoot>
    <tr>
        ...
        <td style="text-align:right;"><b><?php echo 'Rp'.number_format($totalSeluruh,0,",",".");?></b></td>
    </tr>
</tfoot>
</table>
