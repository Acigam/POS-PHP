...
<tr>
    <td colspan="2" style="width:800px"><center><h2 style="margin-bottom:0px">Laporan Penjualan <?php echo $tgl ?></h2></center><br/></td>
</tr>
</table>

<table align='center' width='900px;' border='1'>
<thead>
    <th colspan="11" style="text-align:left;">Tanggal : <?php echo $tgl;?></th>
    <tr>
...
<tbody>
    ...
    $sql = "SELECT detail_penjualan.id_transaksi, tgl_transaksi, karyawan.nama, total, barang.id_barang, 
            ...
            WHERE date(tgl_transaksi) = '$tgl' ORDER BY detail_penjualan.id_transaksi";
